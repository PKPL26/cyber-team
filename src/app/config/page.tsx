      ...
      <section className="grid place-items-center h-screen text-lg font-jetbrains font-extralight px-4">
        <div className="flex flex-col gap-6 w-full max-w-md">
          <div className="border border-foreground/20 p-8 flex flex-col gap-6 bg-background animate-fade-in transition-all relative z-10 items-center shadow-2xl">
            <h1 className="text-foreground text-lg font-extralight text-center">
              you are not authorized to access this page
            </h1>
            <Link href="/">
              <button className="w-full flex-1 text-center px-3 py-2 border border-foreground/20 hover:cursor-pointer hover:border-foreground bg-transparent hover:bg-foreground transition-all text-foreground  hover:text-background font-extralight ">
                back to home
              </button>
            </Link>
          </div>
